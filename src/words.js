...
*/
  ...
  if (wchoix != undefined){                         //on récupère et vérifie que l'endroit qu'on veut modifier existe
    var bt1 = document.createElement("BUTTON");  //on crée de nouveaux éléments button
